package com.dmsgpk.section07.kindsofvariable;
...
public class KindsOfVariable {
    ...
    // non-static field, 인스턴스 변수라고 한다.
    // 인스턴스라고 하는 이유는 인스턴스가 객체인데, 그 객체 생성 시점에 사용 가능한 변수를 의미한다.
    ...
    public void testMethod(int num) {
        ...
        //지역변수를 선언 외에 다시 사용하려고 한다면, 반드시 초기화가 되어야 한다.
        //System.out.println(lacalNum); > 컴파일 에러

        // 전역변수는 클래스 전역에서 사용 가능하다.

        System.out.println(globalNum); //전역 변수는 다른 메소드에서도 사용이 가능하다.
