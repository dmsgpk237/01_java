package com.dmsgpk.section06.singleton;
...
public class Application {
    public static void main(String[] args) {
        ...
        *    두 번째 이용시에는 인스턴스 생성 시간 없이 바로 사용할 수 있다.
        ...
        * */
        ...
        // 이른 초기화
        // EagerSingleton eager = new EagerSingleton(); 생성자가 private라서 접근불가
        ...
        * 하지만 클래스를 로드(메모리에 등록이 된다)하는 속도가 느리다.
        *
        * 게으른 초기화를 사용하면 첫 번째 요청에 대한 속도가 두 번째 요청에 대한 속도보다 느리다.
