...
public class A_If {
        ...
        * if 문은 조건식의 결과 값이 참(true)으로 나오면 {} 안에 있는 코드를 실행하고,
        * 조건식의 결과 값이 거짓(false)로 나오면 {} 안에 있는 코드를 무시한다.
        *
        * */
    ...
    public void testNestedIfStatement() {
        ...
        if(num > 0 ) {
            ...
            } else {System.out.println("입력하신 숫자는 양수지만 짝수가 아닙니다.");}
        } else {System.out.println("입력하신 숫자는 양수가 아닙니다.");}
