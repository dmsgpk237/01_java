...
public class B_IfElse {
     ...
     *
     * if([조건식]) {
     *   // 조건식이 True일 경우 실행 할 명령문
     * } else {
     *   // 조건식이 False일 경우 실행 할 명령문
     * }
     *
    ...
    public void testSimpleIfElseStatement() {
        ...
        if (num % 2 == 1) {
            System.out.print("입력하신 숫자는 홀수입니다.");
            // 홀수가 아니면 "입력하신 숫자는 짝수입니다." 라고 출력하는 코드를 작성해보자.
        } else {
            System.out.print("입력하신 숫자는 짝수입니다.");

        }
        // 단, 조건과 상관없이 프로그램이 종료될 때 "프로그램을 종료하니다."라고 출력되도록 한다.
        System.out.println();
