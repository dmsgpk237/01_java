package com.dmsgpk.section04.comparison;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        *
        * 2. 비교연산자의 종류
        *   '==' : 왼쪽의 피연산자와 오른쪽의 피연산자가 같으면 true 다르면 false를 반환함
        *   '!=' : 왼쪽의 피연산자와 오른쪽의 피연산자가 다르면 true 다르면 false를 반환함
        *   '>'  : 왼쪽의 피연산자가 오른쪽의 피연산자보다 크면 true 작으면 false를 반환함
        *   '>=' : 왼쪽의 피연산자가 오른쪽의 피연산자보다 크거나 같으면 true 아니면 false를 반환함
        *   '<'  : 왼쪽의 피연산자가 오른쪽의 피연산자보다 작으면 true 아니면 false를 반환함
        *   '>=' : 왼쪽의 피연산자가 오른쪽의 피연산자보다 작거나 같으면 true 아니면 false를 반환함
        * */
