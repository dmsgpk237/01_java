package com.dmsgpk.section03.interfaceimplements;
    ...
    // java.io.Serializable, java.util.Comparator 다중상속 받기 가능
public interface InterProduct /* extends java.io.Serializable, java.util.Comparator */{
    ...
    * */
        ...
        // private String name = "ㅇㅇ";
        // 인터페이스에는 상수 필드만 작성이 가능하다.

        //String name;
        int MIN_NUM = 10;
        // 이게 되는 이유는 앞에 묵시적으로 public static final이 명시되기 때문이다.

        // 인터페이스는 생성자를 가질 수 없다.
        // public Interproduct() {}

        // public void nonStaticMethod() {}
        // {} 구현부가 있을 경우에는 만들 수가 없다. {코드를 실행하는 곳}
        ...
        /*
        * 인스턴스 안에 작성하는 메소드는 묵시적으로 public abstract의 의미를 가진다.
        * (다른 접근제한자 사용 불가)
        ...
        * */
        ...
        //static 메소드는 작성이 가능하다 jdk 1.8 이후부터 추가됨.
        ...
        // default 키워드를 사용하면 non-static 메소드도 작성 가능 jdk 1.8 이후부터 추가됨.
