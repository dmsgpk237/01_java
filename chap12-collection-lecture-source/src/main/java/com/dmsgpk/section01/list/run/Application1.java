    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 다형성을 적용해 상위 레퍼런스로 ArrayList 객체를 만들 수 있다.
            ...
            레퍼런스 타입은 List로 해두는게 더 유연한 코드를 작성할 수 있다.
         */
        ...
        * 중간 인덱스 값을 삭제할 경우, 자동으로 인덱스를 하나씩 앞으로 당긴다.
        * */
        list.remove(2);
        list.remove(2);
        list.remove(2);
        ...
        * Collections(관례상 인터페이스 안에 있는 기능을 사용할 수 있게 static으로 구현했다) 클래스를 사용
        * -> collection 사용되는 기능을 static 메서드로 구현한 클래스
        * */
        ...
        LinkedList decendingIterator() 메서드를 사용하면
