...
public class Hair {
    ...
    public Hair(int id, String firstName, String lastName, String email, String gender, LocalDateTime dateOfBirth, LocalDate reservationDate, LocalTime reservationTime, LocalDateTime createdAt) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        Hair hair = (Hair) o;
        return id == hair.id && Objects.equals(firstName, hair.firstName) && Objects.equals(lastName, hair.lastName) && Objects.equals(email, hair.email) && Objects.equals(gender, hair.gender) && Objects.equals(dateOfBirth, hair.dateOfBirth) && Objects.equals(reservationDate, hair.reservationDate) && Objects.equals(reservationTime, hair.reservationTime) && Objects.equals(createdAt, hair.createdAt);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, email, gender, dateOfBirth, reservationDate, reservationTime, createdAt);
    }
