...
public class Application3 {
    public static void main(String[] args) {
        ...
        Function<String, Integer> function = (str) -> Integer.parseInt(str);
                                                    // str로 받은 String 값 매개변수를 int 형으로 바꾼다.
        String strValue = "12345";

        // getClass() : 래퍼타입의 클래스를 가져옴
        System.out.println("결과 출력 : " + function.apply(strValue) + " : "
        ...
        String str1 = "12345";
        String str2 = "67890";
        System.out.println("결과 출력 : " + biFunction.apply(str1, str2)
        ...
        int intValue = 123;
        System.out.println("결과 출력 : " + intFunction.apply(intValue) + " : "
                + intFunction.apply(intValue).getClass().getName());
        // 123 : java.lang.String -> String으로 변환된 것을 확인하기 위해 getClass와 getName 출력
